...
The `scripts/` phase (simulation and analysis automation) is intentionally left for later.
...
- `scripts/simulate.py` and `scripts/analyze.py` are intentionally not added yet.
- This stage focuses on protocol core and mandatory extension modules.
